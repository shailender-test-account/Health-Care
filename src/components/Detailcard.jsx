...
function Detailcard(props) {
    return (
        <motion.div initial={{ opacity: 0, scale: 0.5 }}
            ...
            }} className='max-w-[300px] h-[400px] flex flex-col justify-center items-center border-2 relative shadow-md'>
            <div className='w-[70px] h-[70px] bg-[#ffffff] rounded-full flex justify-center text-[#0da8bc] text-[2rem]  items-center absolute top-[-6%]'>
                {props.icon}
            </div>
            <div className='max-w-[300px] flex  flex-col justify-center items-center p-5 gap-10'>
