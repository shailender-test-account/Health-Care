...
function CarouselTestimonial() {
  ...
  useEffect(() => {
    let url = "https://admin.tomedes.com/api/v1/get-reviews?page=1";
                    ...
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          ...
                          {!data ?"Best Treatment ever":(data[4].Reviews)}
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
                          ...
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">
                              {!data ?"No Name":(data[4].Name)}

                            </span>
                            <cite className="not-italic">
                              <a href="http://www.microsoft.com">
                              {!data ?"xyz":(data[4].Company)}
                ...
                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          {!data ?"Best Treatment ever":(data[2].Reviews)}
                      ...
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
                          ...
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">
                              {!data?"No name":(data[2].Name)}

                            </span>
                            <cite className="not-italic">
                              <a href="http://www.microsoft.com">
                              {!data ?"xyz":(data[2].Company)}
                ...
                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          {!data ?"Best Treatment ever":(data[3].Reviews)}
                      ...
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
                          ...
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">
                              {!data ?"No Name":(data[3].Name)}

                            </span>
                            <cite className="not-italic">
                              <a href="http://www.microsoft.com">
                              {!data ?"xyz":(data[3].Company)}
